...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
	...
	\href{https://billylee.me}{\textbf{{\Large Billy Pak Lam Lee}}} & Email : \href{mailto:billy.pl.lee@gmail.com}{billy.pl.lee@gmail.com}\\
...
{Full Stack Developer Intern (Part-time)}{Jan 2023 - Current}
\resumeItemListStart

\resumeItem{Created responsive and intuitive interfaces using NextJS components and Material UI.}

\resumeItem{Utilized Jest and GitLab pipeline for testing and linting to ensure optimal website performance and maintain high code quality.}
...
{Presales Intern}{Jun 2023 - Aug 2023}
\resumeItemListStart

\resumeItem{Developed demo processes and created demo guides for various HPE GreenLake solutions, including Ezmeral, Private Cloud Enterprise, Aruba SASE, Citrix VDI, Zerto, Azure Stack, and DSCC.}

\resumeItem{Created a React.js webpage to showcase available demos.}
...
\item{
            \textbf{Technologies/Frameworks}{: React, NextJS, Socket.io, Node.js, MongoDB, Mongoose, Styled Components, MaterialUI, TailwindCSS, Jest, Firebase, Selenium, BeautifulSoup4, Git, npm, Webpack, Wordpress, Linux/Unix, Adobe Photoshop, MS Office Suite}
      }
\resumeSubHeadingListEnd
