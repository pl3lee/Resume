...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{\href{https://github.com/pl3lee/cv-project}{CV Generator - HTML/CSS/JavaScript(React)}}
      {Created a webpage that generates a CV using React.}
    \resumeSubItem{\href{https://github.com/pl3lee/memory-game}{Memory Game - HTML/CSS/JavaScript(React)}}
      {Created a web based game that trains your memory using React.}
    \resumeSubItem{\href{https://github.com/pl3lee/Battleship}{Battleship - HTML/CSS/JavaScript(React)}}
      {Created a Battleship game using React.}
