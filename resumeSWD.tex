...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{\href{https://github.com/pl3lee/Biquadris}{Biquadris - C++:}}
      {Created a Tetris game played by 2 players using C++ as a project for the course CS246.}
    \resumeSubItem{{Reverse Polish Notation Mathematical Expression Evaluator - C++:}}
      {Implemented using the Interpreter design pattern. Part of the CS246 curriculum.}
    \resumeSubItem{{Text Processor - C++:}}
      {Given commands dropfirst, doublewords, allcaps, count c, this program modifies the given string. Implemented using the Decorator design pattern. Part of the CS246 curriculum.}
    \resumeSubItem{{Partial Sudoku Solver - C++:}}
      {As the user inputs Sudoku cell values through stdin, this program partially solves the puzzle by using the Observer design pattern, where notified cells, rows, columns, and boxes check if there are any number that are forced through a set of rules. Part of the CS246 curriculum.}
    \resumeSubItem{{Wordle - C++:}}
      {Created the Wordle game, but the length of the word can be arbitrary. Part of the CS246 curriculum.}
    \resumeSubItem{{RunSuite - Bash Script:}}
      {Created a Bash script that checks if a given program matches the output of the given test suite. Part of the CS246 curriculum.}
