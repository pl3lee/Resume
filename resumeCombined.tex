...
\item{
            \textbf{Technologies/Frameworks}{: React, NextJS, Node.js, MongoDB, Netlify, Heroku, Redux Toolkit, Styled Components, MaterialUI, Firebase, Selenium, BeautifulSoup4, Git, npm, Webpack, Wordpress, Linux/Unix, Adobe Photoshop, MS Office Suite}
      }
\resumeSubHeadingListEnd
