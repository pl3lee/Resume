...
{\begin{itemize}
		\item Contributed to the development of a website for a cognitive linguistic research group, leveraging NextJS and TypeScript for the frontend and a Golang REST API for the backend.
		\item Collaborated with senior developers to create responsive and intuitive interfaces using NextJS components.
		...
		\item Improved the search functionality for the figures page by creating an autocomplete dropdown menu that displays associated figures when searching for synonyms.
		\item Developed a search bar on the sources page using MaterialUI, allowing users to easily access relevant content.
