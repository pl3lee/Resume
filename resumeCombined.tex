...
\resumeItemListStart
\resumeItem{
	Managed and maintained the company’s Wordpress website, including writing a Python program using Selenium to automate the updating of product prices and deleting products given a list of model numbers, completing 2 months worth of manual labor in just 4 hours.}
