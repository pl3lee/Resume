...
\item{
            \textbf{Technologies/Frameworks}{: React, NextJS, Node.js, MongoDB, Netlify, Heroku, Redux Toolkit, Styled Components, MaterialUI, Tailwind CSS, Firebase, Selenium, BeautifulSoup4, Git, npm, Webpack, Wordpress, Linux/Unix, Adobe Photoshop, MS Office Suite}
      }
\resumeSubHeadingListEnd
