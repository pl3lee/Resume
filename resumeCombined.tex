...
{\begin{itemize}
		...
		\item Transitioned the front-end framework from Ant Design to Material-UI, resulting in an improved user experience and streamlined development processes.
